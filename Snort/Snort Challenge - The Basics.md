...
The [List of file signatures](<https://en.wikipedia.org/wiki/List_of_file_signatures>) has two entries for GIF's,, and we'll utilise the first one `47 49 46 38 37 61`.  
...
This resulted in alerts of 4 packets, all utilising the same GIF format.
...
### Fix the syntax error in local-1.rules. What is the number of the detected Packets?
...
### Fix the syntax error in local-2.rules. What is the number of the detected Packets?
...
### Fix the syntax error in local-3.rules. What is the nuber of detected Packets?
Original:  
...
### Fix the syntax error in local-4.rules. What is the number of the detected Packets?
Original:  
`alert icmp any any -> any any (msg: "ICMP Packet Found"; sid:1000001; rev:1;)`  
